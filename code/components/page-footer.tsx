    ...
    <footer className="mt-16 mb-20 relative z-10 border-t border-border/50 pt-8">
      <div className="max-w-2xl mx-auto px-4 text-center">
        <p className="text-sm text-muted-foreground mb-4">
          Connect with me across all platforms. Built with Next.js and Tailwind CSS.
        </p>
        ...
        <p className="text-xs text-muted-foreground/60">© {currentYear} Rohit Dudi. All rights reserved.</p>
      </div>
    </footer>
  )
}
